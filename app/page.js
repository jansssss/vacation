...
const featuredCalculators = [
  {
    title: '육아지원금 계산기',
    description: '사업주 지원금, 근로자 예상 수령액, 회사 월 순부담까지 한 번에 확인하는 2026 대표 계산기입니다.',
    ...
    <div className="space-y-14">
          ...
          <div className="space-y-7">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-base leading-relaxed text-slate-600">
                e-work.kr은 복잡한 규정을 겁주는 방식 대신, 바로 써먹을 수 있는
                계산기와 가이드를 제공합니다.
              </p>
              <p className="max-w-xl text-base leading-relaxed text-slate-600">
                이번 특집의 중심은{' '}
      ...
      <section className="space-y-5">
        <div className="flex items-center justify-between">
          ...
          <Link href="/calculators" className="text-sm font-medium text-blue-700 hover:text-blue-900">
            전체 보기 →
          </Link>
        </div>
